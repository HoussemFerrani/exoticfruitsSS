  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        aria-label={isHydrated && !isLoading ? t("general.selectLanguage") : "Select Language"}
        title={`${isHydrated && !isLoading ? t("general.selectLanguage") : "Select Language"} - ${currentLanguage?.name}`}
      >
          ...
          >
            ...
            <div className="bg-[var(--color-brand)] text-white px-3 py-2">
              <div className="flex items-center gap-2">
                <Globe className="w-3 h-3" />
                <span className="font-medium text-xs">{isHydrated && !isLoading ? t("general.selectLanguage") : "Select Language"}</span>
              </div>
            </div>
