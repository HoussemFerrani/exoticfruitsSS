...
export const metadata: Metadata = {
  title: "Exotic Fruits - Premium Colombian Exotic Fruits",
  description:
  ...
  authors: [{ name: "Exotic Fruits" }],
  creator: "Exotic Fruits",
  publisher: "Exotic Fruits",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Exotic Fruits - Premium Colombian Fruits",
      },
    ],
    locale: "en_US",
    type: "website",
